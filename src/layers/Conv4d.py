"""
credit goes to: https://github.com/ZhengyuLiang24/Conv4d-PyTorch/blob/main/Conv4d.py
"""
...
class Conv4d(nn.Module):
    def __init__(self,
        ...
        for i in range(self.kernel_size[0]):
            ...
            conv3d_layer = nn.Conv3d(in_channels=self.in_channels, out_channels=self.out_channels, 
